			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="card card-primary">
						...
						<!-- /.card-header -->
						<!-- form start -->
						<form id="quickForm" action="{{  url('admin/inventory/edit').'/'. $listing->id}}" method="post" enctype="multipart/form-data">
							@csrf
						<div class="card-body">  
								<div class="row">
								   <div class="col-md-6">
										<div class="form-group">
											...
											<select name="cat_id" class="form-control" id="category">
												...
												<option value="{{ $val->id }}"  {{ (old('cat_id') == $val->id || $listing->cat_id == $val->id) ? 'selected' : ''}}>{{ $val->name }}</option>
                                                <?php } } ?>
											</select>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select name="sub_cat_id" id="subcategory" class="form-control">
											    <?php if($listing->subcategory){?>
											    <option value="{{ $listing->sub_cat_id }}" >{{ $listing->subcategory->sub_cat_name }}</option>
											    <?php }else{ ?>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="name" value="{{ old('name',$listing->name) }}" class="form-control" id="name" placeholder="Enter Category Name"> 
    										@if ($errors->has('name'))
								    ...
								    <div class="col-md-6">
										<div class="form-group">
											...
											<input type="number" name="price" value="{{ old('price',$listing->price) }}" class="form-control" id="price" placeholder="Enter price"> 
    										@if ($errors->has('price'))
								...
								<div class="row">
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="number" name="quantity" value="{{ old('quantity',$listing->quantity) }}" class="form-control" id="mobile" placeholder="Enter  quantity"> 
								    ...
								    <div class="col-md-3">
										<div class="form-group">
											...
											<select name="uom_id" class="form-control" onchange="myFunction()">
												...
												<option value="{{ $val1->id }}"  {{ (old('uom_id') == $val1->id || $val1->id == $listing->uom_id) ? 'selected' : ''}}>{{ $val1->name }}</option>
                                                <?php } } ?>
											</select>
								    ...
								    <div class="col-md-6">
										<div class="form-group">
											...
											<input type="number" name="discount" value="{{ old('discount' , $listing->discount) }}" class="form-control" id="discount" placeholder="Enter discount"> 
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select name="status" class="form-control">
												...
												<option value="active"  {{ (old('status') == "active" || $listing->status == "active") ? 'selected' : ''}}>Active</option>
												<option value="inactive" {{ (old('status') === "inactive" || $listing->status == "inactive") ? 'selected' : ''}}>Inactive</option>
								...
								<div class="row">
								    <div class="col-md-6">
										<div class="form-group">
											...
											<input type="number" name="sales_commission" value="{{ old('sales_commission',$listing->sales_commission ) }}" class="form-control" id="name" placeholder="Enter sales commission" required> 
										...
										<div class="form-group">
											...
											<textarea class="form-control" id="w3review" name="description" rows="2" cols="50">{{ old('description',$listing->description)}}</textarea>
