          ...
          <div class="card-header">
            <h3 class="card-title">Product Listing</h3>
             <div class=" ml-auto w-75 text-right ">
                <a href="{{url('admin/inventory/add')}}" class="btn btn-primary btn-sm px-4"> Add</a>
             </div>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
               ...
               <?php  } ?></td>
                <td>
                    <a href="{{url('admin/inventory/edit').'/'.$val->id }}"><i class="fas fa-edit"></i></a> |
                    <a href="{{url('admin/inventory/delete').'/'.$val->id }}"><i class="fas fa-trash"></i></a>
                </td>
                 <td>
