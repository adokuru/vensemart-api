      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Tranding Product Listing</h3>
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form action="{{url('admin/inventory/tranding')}}" method="POST">
                @csrf
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                <td><?php if ($val->is_tranding == "1") { ?>
                      <input type="checkbox" name="selected[]" class="checkboxes" value="<?php echo $val->id; ?>" checked="checked" />
                  <?php } else { ?>
                      <input type="checkbox" name="selected[]" class="checkboxes" value="<?php echo $val->id; ?>" />
                  <?php } ?>
                </td>
                <td>{{ $val->name }}</td>
             ...
             <input type="submit" value="update tranting" name="submit" class="btn btn-primary">
             </form>
          </div>
              <!-- /.card-body -->
            </div>
