				...
				<div class="col-md-12">
					...
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Add Sub Category</h3> </div>
						<!-- /.card-header -->
						<!-- form start -->
						<form id="quickForm" action="{{  url('admin/managesubcategory/add')}}" method="post" enctype="multipart/form-data">
							@csrf
							<div class="card-body">
								<div class="row">
								    <div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="sub_cat_name" value="{{ old('sub_cat_name') }}" class="form-control" id="sub_cat_name" placeholder="Enter Category Name"> 
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="file" name="sub_cat_image" class="form-control" accept="image/*" id="sub_cat_image" placeholder="Enter Sub Category Image"> 
