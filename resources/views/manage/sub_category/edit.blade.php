                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="category_id" class="form-control">
                                                    ...
                                                    <option value="{{ $cat_list->id }}" <?php if ($cat_list->id == $subCat->cat_id) {
                                                        echo 'Selected';
                                                    } ?>>{{ $cat_list->category_name }}</option>
                                                    <?php } }?>
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <img src="{{ url('storage/subcategory_images') }}/{{ $subCat->image }}" width="80px;" height="80px;">
