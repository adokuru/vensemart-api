...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="container-fluid">
				<form id="quickForm" action="{{  url('admin/new-driver/edit').'/'.$driver->id}}" method="post" enctype="multipart/form-data">
    		@csrf
    			<div class="row">
    				<!-- left column -->
        				<div class="col-md-12">
    								...
    								<div class="row">
    									<div class="col-md-6">
    										<div class="form-group">
    											...
    											<input type="text" name="name" value="{{ old('name',$driver->name) }}" class="form-control" id="name" placeholder="Enter Category Name"> 
        										@if ($errors->has('name'))
    								    ...
    								    <div class="col-md-6">
    										<div class="form-group">
    											...
    											<input type="email" name="email" value="{{ old('email',$driver->email) }}" class="form-control" id="email" placeholder="Enter Email"> 
        										@if ($errors->has('email'))
    								...
    								<div class="row">
    									<div class="col-md-6">
    										<div class="form-group">
    											...
    											<input type="number" name="mobile" value="{{ old('mobile',$driver->mobile) }}" class="form-control" id="mobile" placeholder="Enter Mobile Number"> 
    								...
    								<div class="row">
    								    <div class="col-md-6">
    										<div class="form-group">
    											...
    											<input type="text" name="vehicle_number" value="{{ old('vehicle_number',$driver->vehicle_reg->vehicle_number) }}" class="form-control" id="name" placeholder="Enter Vehicle Number"> 
    								    ...
    								    <div class="col-md-6">
    										<div class="form-group">
    											...
    											<input type="text" name="vehicle_manufacture_company" value="{{ old('vehicle_manufacture_company',$driver->vehicle_reg->vehicle_manufacture_company) }}" class="form-control" id="vehicle_manufacture_company" placeholder="Enter Vehicle Manufacture Company"> 
    								    ...
    								    <div class="col-md-6">
    										<div class="form-group">
    											...
    											<input type="text" name="vehicle_model" value="{{ old('vehicle_model',$driver->vehicle_reg->vehicle_model) }}" class="form-control" id="vehicle_model" placeholder="Enter vehicle_model"> 
    								    ...
    								    <div class="col-md-6">
    										<div class="form-group">
    											...
    											<input type="number" name="vehicle_registration_year" value="{{ old('vehicle_registration_year',$driver->vehicle_reg->vehicle_registration_year) }}" class="form-control" id="vehicle_registration_year" placeholder="Enter Vehicle Registration Year"> 
    								    ...
    								    <div class="col-md-6">
    										<div class="form-group">
    											...
    											<input type="text" name="vehicle_owner_name" value="{{ old('vehicle_owner_name',$driver->vehicle_reg->vehicle_owner_name) }}" class="form-control" id="vehicle_owner_name" placeholder="Enter vehicle_owner_name"> 
