    ...
    <section class="content">
     ...
     <div class="card card-danger">
             ...
             <div class="row">
              ...
              <div class="row">
                 <div class="col-md-6">
                        <div class="d-flex w-100 justify-content-start">
                          ...
                          <div class="input-group">
                            <p class="ml-2">{{$driver_details->name}}</p>
                          </div>
                          <!-- /.input group -->
                        </div>  
                    </div>
                ...
                <div class="col-md-6">
                        <div class="d-flex w-100 justify-content-start">
                          ...
                          <div class="input-group">
                            <p class="ml-2">{{$driver_details->email}}</p>
                          </div>
                          <!-- /.input group -->
                        </div>  
                    </div> 
                ...
                <div class="col-md-6">
                        <div class="d-flex w-100 justify-content-start">
                          ...
                          <div class="input-group">
                            <p class="ml-2">{{$driver_details->mobile}}</p>
                          </div>
                          <!-- /.input group -->
                        </div>  
                    </div>     
              ...
              <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable no-footer" role="grid" aria-describedby="example1_info">
                 <thead>
                  <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="discounted Price: activate to sort column ascending">discounted Price</th></tr>
                </thead>
                <tbody>
                 ...
                 ?>
                  <tr >
                    ...
                    <td><img src="{{url('storage/app/product_images')}}/{{$value->p_image}}" width="50px;" height="50px;"></td>
