  ...
  <div class="col-md-12" style="padding: 15px 0px; width:95%; margin:0px 10px;background: #fff; padding:0px 0px 20px 0px;">
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
            <div class="form-body">
            <form  action="{{ url('admin/order/completed_orders/editorders') }}/{{$order->order_id}} " method="post" id="menu_add" >
                @csrf
                <div class="row">
                    <div class="form-group col-md-6">
                      <label for="order">Order Number:</label>
                      <div>
                          <input type="hidden" name="order_id" value="{{$order->order_id}}">{{$order->order_id}}
                      </div>
                    </div>
                    <div class="form-group col-md-6">
