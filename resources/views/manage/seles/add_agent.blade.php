				...
				<div class="col-md-12">
					...
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Add Agent</h3> </div>
						<!-- /.card-header -->
						<!-- form start -->
						<form id="quickForm" action="{{  url('admin/sales-agent/add').'?sales='. $is_q }}" method="post" enctype="multipart/form-data">
							@csrf
							<div class="card-body">
								...
								<div class="row">
										...
										<div class="form-group">
											...
											<textarea id="location" name="location" class="form-control" name="location" rows="2" cols="40"></textarea>
