...
<div class="card ">
   ...
   <!-- form start -->
    ...
    <div class="col-md-12 m-auto" id="form_container">
        ...
        <form role="form" method="post" action="{{url('admin/feedback/reply').'/'.$feedbacks->id}}  " id="reused_form">
            @csrf
                <div class="row">
                <div class="col-sm-6 form-group">
                    <label for="message">
                        Message :</label>
                    <textarea class="form-control" type="textarea" name="feedback" id="message" maxlength="6000" rows="7">{{Old('',$feedbacks->feedback)}}</textarea>
                </div>
                <div class="col-sm-6 form-group">
                    <label for="reply">
                        Reply :</label>
                    <textarea class="form-control" type="textarea" name="feedback_reply" id="reply" maxlength="6000" rows="7"></textarea>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 form-group">
                    <label for="email">
                        Email:</label>
                    <input type="email" readonly class="form-control" id="email" name="email" value="{{ $feedbacks->user->email }}" required="">
                </div>
            </div>
