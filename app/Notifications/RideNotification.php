...
class RideNotification extends Notification
{
    ...
    //     if ($notifiable->type == 2 && env('ONESIGNAL_DRIVER_APP_ID') && env('ONESIGNAL_DRIVER_REST_API_KEY')) {
    //         $heading = [
    //             'en' => $this->subject,
    //         ];
    ...
    //             'include_player_ids' => [$notifiable->device_token],
    //             'headings' => $heading,
    //             'contents' => $content,
    //             'data'  => [
    //                 'id' => $this->data['id'],
    ...
    //         // dd($onesignal_client, $parameters);
    ...
    //     if (env('FIREBASE_SERVER_KEY') && $notifiable->type == 1) {
