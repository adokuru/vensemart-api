        ...
        try {
            ...
            foreach ($data as $val) {
                ...
                $val->service_provider_rating = DB::table('servicebook_user')
                    ...
                    ->avg('rating');
                $val->service_provider_rating = number_format((float) $data->service_provider_rating, 1, '.', '');
            }
    ...
    public function service_update_profile(Request $request)
    {
        ...
        try {
            ...
            if (!empty($request->profile)) {
                ...
                // $store = $request->file('profile')->move(base_path('storage/app/public/uploads/profile', $file_name));
