...
class ApiController extends Controller
{
    ...
    public function get_order_request()
    {
        ...
        if ($on_ride_request != null) {
            ...
            $driver = User::find($on_ride_request->driver_id);
            if ($driver) {
    ...
    public function update_order_request(Request $request, $id)
    {
        ...
        try {
            ...
            if ($request->status == "cancelled") {
                ...
                // if ($driver == null) {
                $test =                $this->contactRiderForDelivery($orders->order_id, $user_id, $ride_request->start_address, $ride_request->end_address, $ride_request->start_latitude, $ride_request->start_longitude);
                // }
